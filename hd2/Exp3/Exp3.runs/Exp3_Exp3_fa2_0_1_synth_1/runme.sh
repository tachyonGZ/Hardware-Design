...
HD_PWD='D:/MyCode/hd2/Exp3/Exp3.runs/Exp3_Exp3_fa2_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exp3_Exp3_fa2_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exp3_Exp3_fa2_0_1.tcl
