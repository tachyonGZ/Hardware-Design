...
HD_PWD='D:/MyCode/hd2/Exp3/Exp3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Exp3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Exp3_wrapper.tcl
