...
HD_PWD='D:/MyCode/hd2/Exp3/Exp3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Exp3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Exp3_wrapper.tcl -notrace
