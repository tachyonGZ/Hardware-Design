...
#
# Script generated by Vivado on Sat Jul 13 20:37:22 +0800 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : add_dec4.sh
...
#
# Usage        : add_dec4.sh
#                add_dec4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                add_dec4.sh [-reset_run]
#                add_dec4.sh [-reset_log]
#                add_dec4.sh [-help]
#
...
# script info
echo -e "add_dec4.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./add_dec4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot add_dec4 xil_defaultlib.add_dec4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim add_dec4 -key {Behavioral:sim_1:Functional:add_dec4} -tclbatch cmd.tcl -protoinst "protoinst_files/add_dec4.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb add_dec4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./add_dec4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: add_dec4.sh [-help]\n\
Usage: add_dec4.sh [-step]\n\
Usage: add_dec4.sh [-lib_map_path]\n\
Usage: add_dec4.sh [-reset_run]\n\
Usage: add_dec4.sh [-reset_log]\n\
Usage: add_dec4.sh [-keep_index]\n\
Usage: add_dec4.sh [-noclean_files]\n\n\
