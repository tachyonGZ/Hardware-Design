...
#
# Script generated by Vivado on Wed Jul 10 18:18:59 +0800 2024
...
#
# Usage        : ha4.sh
#                ha4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                ha4.sh [-reset_run]
#                ha4.sh [-reset_log]
#                ha4.sh [-help]
#
...
# script info
echo -e "ha4.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./ha4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ha4 xil_defaultlib.ha4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim ha4 -key {Behavioral:sim_1:Functional:ha4} -tclbatch cmd.tcl -protoinst "protoinst_files/ha4.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb ha4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./ha4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: ha4.sh [-help]\n\
Usage: ha4.sh [-step]\n\
Usage: ha4.sh [-lib_map_path]\n\
Usage: ha4.sh [-reset_run]\n\
Usage: ha4.sh [-reset_log]\n\
Usage: ha4.sh [-keep_index]\n\
Usage: ha4.sh [-noclean_files]\n\n\
