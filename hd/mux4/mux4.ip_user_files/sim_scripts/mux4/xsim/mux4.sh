...
#
# Script generated by Vivado on Thu Jul 11 13:58:49 +0800 2024
...
#
# Usage        : mux4.sh
#                mux4.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                mux4.sh [-reset_run]
#                mux4.sh [-reset_log]
#                mux4.sh [-help]
#
...
# script info
echo -e "mux4.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./mux4.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot mux4 xil_defaultlib.mux4 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim mux4 -key {Behavioral:sim_1:Functional:mux4} -tclbatch cmd.tcl -protoinst "protoinst_files/mux4.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb mux4.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./mux4.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: mux4.sh [-help]\n\
Usage: mux4.sh [-step]\n\
Usage: mux4.sh [-lib_map_path]\n\
Usage: mux4.sh [-reset_run]\n\
Usage: mux4.sh [-reset_log]\n\
Usage: mux4.sh [-keep_index]\n\
Usage: mux4.sh [-noclean_files]\n\n\
