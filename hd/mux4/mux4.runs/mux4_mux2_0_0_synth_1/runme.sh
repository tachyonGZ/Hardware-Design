...
HD_PWD='D:/MyCode/hd/mux4/mux4.runs/mux4_mux2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_mux2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4_mux2_0_0.tcl
