...
HD_PWD='D:/MyCode/hd/mux4/mux4.runs/mux4_mux2_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4_mux2_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux4_mux2_0_2.tcl
