...
#
# Script generated by Vivado on Thu Jul 11 19:29:02 +0800 2024
...
#
# Usage        : cmp_0.sh
#                cmp_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                cmp_0.sh [-reset_run]
#                cmp_0.sh [-reset_log]
#                cmp_0.sh [-help]
#
...
# script info
echo -e "cmp_0.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./cmp_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot cmp_0 xil_defaultlib.cmp_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim cmp_0 -key {Behavioral:sim_1:Functional:cmp_0} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb cmp_0.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./cmp_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: cmp_0.sh [-help]\n\
Usage: cmp_0.sh [-step]\n\
Usage: cmp_0.sh [-lib_map_path]\n\
Usage: cmp_0.sh [-reset_run]\n\
Usage: cmp_0.sh [-reset_log]\n\
Usage: cmp_0.sh [-keep_index]\n\
Usage: cmp_0.sh [-noclean_files]\n\n\
